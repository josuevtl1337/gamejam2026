...
chart_data_lvl2 = json_parse(level2_json);
chart_data_lvl3 = json_parse(level3_json);
...
function load_level()
{
	...
	current_commentary = data.commentary;
	current_available_keys = data.available_keys;
}
